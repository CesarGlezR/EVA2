    ...
    Scanner input = new Scanner(System.in);
        ...
        if (bSi == true) {
            ...
            if (bSi == true) {
                ...
                bSi = input.nextBoolean();
                if (bSi == true) {
                    System.out.println("¿Tiene alguno de los siguientes sintomas: dolor cuando inclina la cabeza hacia delante, nauseas, vomitos, fuertes molestia en los ojos ante una luz brillante, somnolencia o confucion?");
                    bSi = input.nextBoolean();
                    if (bSi == true) {
